...
def  create_parser():
    ...
    parser_positional = argparse.ArgumentParser(add_help=False, conflict_handler="resolve")
    ...
    parser_optional = argparse.ArgumentParser(add_help=False, conflict_handler="resolve")
    parser_optional.add_argument("-o", "--output", type=str, help="Path to the output folder.", default="nanomotif")
    ...
    ###########################################################################
    # Find Motifs
    parser_shared_find_motifs = argparse.ArgumentParser(add_help=False, conflict_handler="resolve")
